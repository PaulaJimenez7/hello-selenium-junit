...
public class RobobarRPTest{

    private static final String baseURL = "http://10.250.13.1:3000/";
    private static final String hubRemoteAddress = "http://127.0.0.1:4444/wd/hub";
    ...
    public static Collection browserData() {
        return Arrays.asList("chrome", "opera", "firefox");
    }

    public RobobarRPTest(String browser) {
